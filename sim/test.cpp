...
void init_test() {
    ...
    switch (args.test) {
        ...
        case 18:
            ...
            test_args[2].test_records.emplace_back(112, test_record_t{true, 0x00000101});
            test_args[2].test_goldens.emplace_back(112,
                                                   test_result_t{INVALID, DIR_INVALID, 0x00000101, 0x100, 0x0, 0x0});

            test_args[0].test_records.emplace_back(112, test_record_t{true, 0x00000101});
            test_args[0].test_goldens.emplace_back(112,
                                                   test_result_t{INVALID, DIR_INVALID, 0x00000101, 0x100, 0x0, 0x0});
            break;
        case 19:
            test_args[0].test_cases.emplace_back(0, test_case_t{true, 0x00000101, 0x100});
